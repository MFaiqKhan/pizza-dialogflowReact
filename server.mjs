...
app.post("/talktochatbot", async (req, res) => {
  const projectId = "weatherassistant-bloj"; // replace with your project ID
...
app.post("/webhook", (req, res) => {
    ...
    function welcome(agent) {
        ...
        agent.add(`I can tell you the weather for any city in the world, you can ask me!!`);
        agent.add(new Suggestion(`What's the weather in Karachi?`));
        agent.add(new Suggestion(`What's the weather in Lahore?`));
        agent.add(new Suggestion(`What's the weather in Newyork?`));
    }

    let weatherIntent = (agent) => { 
